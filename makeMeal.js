const carbs = ["rice noodles", "pasta", "rice", "cereal", "bread", "oats", "red beans"];
const protein = ["chickpeas", "chicken", "beef", "pork", "eggs", "lentils", "cottage cheese", "greek joghurt", "natural joghurt", "turkey", "joghurt", "salmon", "cod", "tuna", "mackerel", "black beans"];
const vegetables = ["potoato", "cucumber", "paprika", "tomato", "brussels", "sweet potato", "broccoli", "peas", "carrot", "lettuce", "celery", "califlower"];
const fruit = ["apple", "pear", "kiwi", "berries", "pineapple", "banana", "corn", "orange", "lemon", "grapes", "cherries"];
